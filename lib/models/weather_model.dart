...
class WeatherModel {
  ...
  String cityName; // Add this property
  ...
  WeatherModel({
    ...
    required this.cityName, // Include it in the constructor
  });
  ...
  factory WeatherModel.fromJson(dynamic data) {
    ...
    return WeatherModel(
      ...
      cityName: data['location']['name'], // Map cityName from API response
    );
  }

  @override
  String toString() {
    return 'City = $cityName, Temp = $temp, MinTemp = $minTemp, Date = $date';
  }
